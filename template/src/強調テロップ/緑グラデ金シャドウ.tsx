...
export const GreenGradation: React.FC<GreenGradationProps> = ({
  subtitleData,
  fontSize = 90,
  bottomOffset = 80,
        ...
        <svg
          ...
          style={{
            ...
            filter: `
              ...
              drop-shadow(0 0 8px rgba(255,200,0,1))
              drop-shadow(0 0 15px rgba(255,200,0,0.7))
            `,
          }}
        >
          <defs>
            <linearGradient
              id="greenGradVerticalGrad"
          ...
          {currentSubtitle.lines.map((line, i) => (
            <React.Fragment key={i}>
              ...
              <text
                ...
                textAnchor="middle"
                stroke="url(#greenGradGoldVerticalGrad)"
                strokeWidth={18}
              ...
              <text
                ...
                strokeLinejoin="round"
                strokeLinecap="round"
                fill="url(#greenGradVerticalGrad)"
