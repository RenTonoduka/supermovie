...
export const WhiteRedShadow: React.FC<WhiteRedShadowProps> = ({
  subtitleData,
  fontSize = 100,
  fontColor = "white",
  strokeColor = "#C80000",
      ...
      >
        <svg
          ...
          style={{
            ...
            overflow: "visible",
            filter: `
              drop-shadow(0 0 10px rgba(200,0,0,1))
              drop-shadow(0 0 20px rgba(200,0,0,0.8))
              drop-shadow(0 0 35px rgba(200,0,0,0.5))
            `,
          }}
        >
          <text
